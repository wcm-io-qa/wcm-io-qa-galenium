 ...
 * @since 4.0.0
 */
public class StringListPersistence implements SamplePersistence<List<String>> {

  private SampleReader<List<String>> reader;
  private SampleWriter<List<String>> writer;
   ...
   */
  public StringListPersistence(Class clazz) {
