...
public final class Persistence {
   ...
   * @return a {@link io.wcm.qa.glnm.verification.persistence.SamplePersistence} for boolean samples
   * @since 4.0.0
   */
   ...
   *
   * @param clazz to fetch and persist resource for
   * @return a {@link io.wcm.qa.glnm.verification.persistence.SamplePersistence} for integer samples
   * @since 4.0.0
   */
   ...
   *
   * @param clazz to fetch and persist resource for
   * @return a {@link io.wcm.qa.glnm.verification.persistence.SamplePersistence} for sampled lists of strings
   * @since 4.0.0
   */
